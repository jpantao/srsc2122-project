...
public class DTLSSocket extends DatagramSocket {
    ...
    public void send(DatagramPacket packet SRTSPProtocol srtsp) throws IOException {
        srtsp.createPacket(packet); //SRTSP packet as the DTLS packet payload
        super.send(packet);
    }

    public void receive(DatagramPacket packet, SRTSPProtocol srtsp) throws IOException {
	// etc ...
        }
    }

    public void send(DatagramPacket packet, SAPKDPProtocol sapkdp) throws IOException {
        sapkdp.createPacket(packet); //SAPKDP packet as the DTLS packet payload
        super.send(packet);
    }

    public void receive(DatagramPacket packet, SSPProtocol ssp) throws IOException {
	// etc ...
        }
    }
