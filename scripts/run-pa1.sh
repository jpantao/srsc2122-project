...
java -cp target/srsc-project-PA1.jar proxybox.ProxyBox -user jpantao -password password -keystore keystores/this.keystore -proxyinfo config/proxybox.properties -movie $1 -voucher $2 | tee log/proxybox.log
